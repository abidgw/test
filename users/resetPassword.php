        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Enter your password.</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <form id="reset">
                <div class="form-group mb-3">
                    ...
                    <div class="input-group input-group-merge input-group-alternative">
                        ...
                        <input class="form-control" placeholder="Confirm Password" type="password" id="cpassword" required>
                    </div>
                    </div>
                ...
                <div class="text-center">
                  <input id="submit" onClick="resetPassword()" class="btn btn-primary" value="Reset" type="button" name="submit">
                </div>
              </form>
            </div>
          </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2020 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Think Exam</a>
          </div>
        </div>
        <div class="col-xl-6">
