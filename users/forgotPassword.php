        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Enter email to reset your password.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form id="forgot">
                ...
                <div class="text-center">
                  <input id="submit" onClick="forgotPassword()" class="btn btn-primary" value="Send Mail" type="button" name="submit">
                </div>
              </form>
            </div>
          </div>
